...
Visit [Exercise Buddy](https://ralphmolu.github.io/exercise_buddy/)
...
## Description 📖
Exercise Buddy is a user-friendly web application designed to help individuals find exercises tailored to their specific needs. It has functionalities that cater to a variety of users: whether they are targeting a particular muscle group or exploring different workout types within their selected difficulty levels.
